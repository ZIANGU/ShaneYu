...
- 📅 **岁月痕迹** - 按时间线展示文章归档
- 👤 **关于页面** - 独立的 About 页面模板，包含个人信息、联系方式、技能、项目、经历等模块
- 💼 **个人技能** - 技能熟练程度展示（精通/熟练/了解/入门），支持多语言翻译
- 📁 **我的项目** - 项目卡片展示，支持图标、描述、技术栈和链接
- 📜 **个人经历** - 时间线展示个人经历，日期与内容清晰对齐
- 🏷️ **个人标签** - 关联文章标签的个人标签系统
- 🔤 **页面别名** - 支持为各页面配置自定义标题，支持四种语言
...
| 👤 **关于**     | 个人信息展示 · 联系方式（社交链接） · 个人技能（含熟练度） · 我的项目卡片 · 个人经历时间线 · 支持 HTML 内容 · 多语言翻译                           |
